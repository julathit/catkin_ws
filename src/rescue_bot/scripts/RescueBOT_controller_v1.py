...
class RobotController:
    def __init__(self):
        ...
        self.servo_pub = rospy.Publisher('servo_angle', servo_angle, queue_size=30)
        self.motor_pub = rospy.Publisher('drive_motor', drive_motor, queue_size=30)
        self.light_pub = rospy.Publisher('light_control', Bool, queue_size=10)
